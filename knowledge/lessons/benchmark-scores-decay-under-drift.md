---
type: Lesson
id: benchmark-scores-decay-under-drift
code: benchmark-scores-decay-under-drift
title: A passed benchmark certifies the network you trained on, not today's
domain: engineering
insight: Before trusting a benchmark pass as proof of readiness, know that telecom data is non-stationary — traffic, vendors, and topology shift — so a stale certification overstates real competence by a measurable margin.
evidence: Agents that passed netops-exam degraded a median 14 points (on a 100-point scale) on a held-out re-test after 6 months of unmodeled network change; quarterly re-certification held effective accuracy within 3 points of the original.
source: Certification durability tracking across exam cohorts, 2025-2026
confidence: medium
appliesTo: [netops-exam, netint-exam, resil-exam, grow-exam, comm-exam, AGENG-101]
applyCount: 0
