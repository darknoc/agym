---
type: Lesson
id: customer-360-needs-network-context
code: customer-360-needs-network-context
title: A churn-risk customer is often a network problem wearing a billing mask
domain: commercial
insight: Before acting on a customer's commercial profile, know that a large share of 'commercial' dissatisfaction traces to network experience on that customer's specific serving cells, not to price or product.
evidence: Joining Customer-360 churn flags to serving-cell experience showed 43% of high-churn-risk consumer accounts were served by cells in the worst experience decile; remediating those cells reduced 90-day churn-intent score by 2.4x more than the best-performing retention offer in the same cohort.
source: Customer-360 x RAN experience correlation, retention cohort, 2025-H2
confidence: medium
appliesTo: [customer-360, COMM-101, COMM-220, NETOPS-220, comm-exam]
applyCount: 0
tags: [lesson, commercial]
---
